...
def add_predictions(input_data):
    ...
    if prediction[0] == 0 :
        ...
        st.write("<span class='diagnosis malicious'>Malicious</span>",unsafe_allow_html=True) # Display the prediction result in the Streamlit app.
...
def main():
    ...
    with st.container():
        ...
        st.write("Please conect this app to your cytology lab to help diagnose breast cancer form tissus sample. Thsi app predicts using a machine learning model whether a breast mass is benign or malignant based on measeurements if receives from cytosis lab. You can also update the measurements by hand using the sliders in the sidebar.")
